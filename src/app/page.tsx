        ...
        >
          ...
          <div className="relative">
            <input
              ...
              className={`px-4 py-3 rounded-md border ${emailError
                ? 'border-red-300 focus:ring-red-500'
                : 'border-gray-300 focus:ring-indigo-500'
                } focus:outline-none focus:ring-2 placeholder-gray-400 text-gray-700 w-full ${isFormDisabled ? 'bg-gray-100 cursor-not-allowed opacity-60' : ''
                }`}
              value={emailToSend}
          ...
          <div className="relative">
            <input
              ...
              className={`px-4 py-3 rounded-md border ${passwordError
                ? 'border-red-300 focus:ring-red-500'
                : 'border-gray-300 focus:ring-indigo-500'
                } focus:outline-none focus:ring-2 placeholder-gray-400 text-gray-700 w-full ${isFormDisabled ? 'bg-gray-100 cursor-not-allowed opacity-60' : ''
                }`}
          ...
          <button
            ...
            className={`py-3 rounded-md font-semibold transition duration-300 flex items-center justify-center ${isSubmitDisabled
